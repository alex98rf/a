...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="row">
            ...
            <h1>BUGGATTI VEYRON </h1>
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <img src="{{ asset('assets/landing/assets/img/bugatti.png') }}" class="img-fluid" alt=""> 
            </div>
    ...
    <p class="fst-italic" style="text-align: justify">
        El Bugatti Veyron fue el superdeportivo que firmó el regreso de Bugatti como fabricante, perteneciendo ya al Grupo Volkswagen y convirtiéndose en el coche halo de todo el grupo automovilístico al emplear la soluciones más avanzadas del momento. 
        El Veyron fue un proyecto que tomó numerosos años hasta ser llevado a producción, un modelo que supuso toda una revolución en la industria del automóvil llevando las prestaciones mucho más allá de lo que habían planteado marcas como Ferrari, Lamborghini o Porsche por aquel entonces. El Bugatti Veyron, con sus 1.001 CV y 408 Km/h, marcó un hito en la historia del automóvil
        ...
        Sin embargo no es el coche más rápido que existe , el Buggatti Veyron Super Sport consiguió alcanzar los 431.072 Km/h en el año 2010 haciéndose con el récord. Disfruta de uno de los coches más rápidos del mundo.
                                                                    ...
                                                                    <td class="checkout-product">
                                                                        <div class="product-cart d-flex">
                                                                            ...
                                                                            <div class="product-content media-body">
                                                                                <h5 class="title"><a href="#alquilaa">BUGGATTI VEYRON</a></h5>
                                                                                <ul>
                                                                                    <li><span>Eco</span></li>
                                                                                    <li><span>Gr</span></li>
