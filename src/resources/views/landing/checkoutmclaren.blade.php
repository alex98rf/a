...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <img src="{{ asset('assets/landing/assets/img/mclaren.png') }}" class="img-fluid" alt=""> 
            </div>
    ...
    <p class="fst-italic" style="text-align: justify">
        ...
        El propulsor del Senna es una nueva evolución del motor 4.0 V8 Twin-Turbo (M840TR) del McLaren 720S para alcanzar los 800 CV de potencia máxima y los 800 Nm de par.
        La transmisión emplea una caja de cambios de doble embrague con 7 relaciones y tracción trasera.
                                                                    ...
                                                                    <td class="checkout-product">
                                                                        <div class="product-cart d-flex">
                                                                            ...
                                                                            <div class="product-content media-body">
                                                                                <h5 class="title"><a href="#alquilaa">MCLAREN SENNA</a></h5>
                                                                                <ul>
                                                                                    <li><span>Eco</span></li>
                                                                                    <li><span>Gr</span></li>
