...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="row">
            ...
            <h1>LAMBORGHINI CENTENARIO ROADSTER </h1>
            </div>
            <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <img src="{{ asset('assets/landing/assets/img/black-lamborghini-centenario.png') }}" class="img-fluid" alt=""> 
            </div>
    ...
    <p class="fst-italic" style="text-align: justify">
        Comprometido con el rendimiento, el Centenario Roadster se basa en un monocasco y en la carrocería de fibra de carbono. El motor V12 suministra 770 CV. Las cifras de la aceleración son increíbles (de 0 a 100 km/h en tan solo 2,9 segundos), así como las de frenada (de 100 a 0 km/h en apenas 31 m). El modelo adopta el nuevo sistema Lamborghini de dirección trasera.
        Cada detalle se ha depurado al máximo para obtener la mejor solución de diseño y ofrecer una experiencia de conducción óptima en términos de confort en el habitáculo. Un ejemplo es el canal situado en el panel trasero de la parte de atrás del reposacabezas, que permite dirigir un flujo de aire regular desde la cabina hacia la parte trasera del capó. 
        Los diseñadores del Centro Stile Lamborghini, conocidos por haber ya probado colores de vanguardia, han desarrollado específicamente para el Centenario Roadster la pintura exterior especial «Argento Centenario». Para obtener este acabado opaco especial, los diseñadores han utilizado un nuevo proceso de elevado contenido tecnológico.  
    </p>  
    </div>
                                                                    ...
                                                                    <td class="checkout-product">
                                                                        <div class="product-cart d-flex">
                                                                            ...
                                                                            <div class="product-content media-body">
                                                                                <h5 class="title"><a href="#alquilaa">LAMBORGHINI ROASTER CENTERARIO</a></h5>
                                                                                <ul>
                                                                                    <li><span>Eco</span></li>
                                                                                    <li><span>Gr</span></li>
